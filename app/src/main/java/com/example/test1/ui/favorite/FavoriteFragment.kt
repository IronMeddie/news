...
@AndroidEntryPoint
class FavoriteFragment : Fragment(), NewsViewHolder.Liked {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.list.observe(viewLifecycleOwner){
            newsAdapter.updateListAddHeader(viewModel.updateListLikes(it.toMutableList()), HEADER_Favorite)
        }
    ...
    override fun onClickLiked(article: Article) {
        ...
        newsAdapter.itemRemoved(article)
    }
